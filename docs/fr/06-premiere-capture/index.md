---
title: Réaliser votre première capture 360°
...
Avant de déclencher, prenez 30 secondes pour vérifier :

<CardGrid cols="3">
  <Card icon="🔋" title="Batterie">
...
## Lancer la capture depuis l'application

<VideoPlaceholder id="media:launch-capture-mobile" />
...
[**7. Comprendre le lien avec RICOH360 Cloud →**](/fr/07-comprendre-cloud/)
