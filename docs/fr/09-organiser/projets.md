...
<JourneyStep
  number="9B"
  objective="Suivre un site, un chantier ou une intervention sur la durée en regroupant tous les panoramas concernés dans un projet."
  outcome="Vous savez créer un projet, y ajouter des panoramas et exploiter cette vue temporelle pour suivre l'évolution du site."
>
...
[**9C. Mes plans →**](/fr/09-organiser/plans)
